    ...
    <View className="profile-page">
      ...
      <View className="form-section">
        ...
        <Picker
          ...
          onChange={(e) =>
            handleFieldChange("political", politicalOptions[e.detail.value as number])
          }
        >
          <View className="form-item">
      ...
      <View className="form-section">
        ...
        <Picker
          ...
          onChange={(e) =>
            handleFieldChange("education", educationOptions[e.detail.value as number])
          }
        >
          <View className="form-item">
      ...
      <View className="form-section">
        ...
        <Picker
          ...
          onChange={(e) =>
            handleFieldChange("workYears", workYearsOptions[e.detail.value as number])
          }
        >
          <View className="form-item">
