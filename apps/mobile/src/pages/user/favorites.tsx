...
export default function FavoritesPage() {
  const [favorites, setFavorites] = useState<FavoritePosition[]>([
    { id: 1, name: '税务局科员', department: '国家税务总局北京市税务局', location: '北京', matchScore: 85, addTime: '2024-01-15' },
    { id: 2, name: '海关科员', department: '北京海关', location: '北京', matchScore: 78, addTime: '2024-01-14' },
    { id: 3, name: '统计局科员', department: '国家统计局上海调查总队', location: '上海', matchScore: 92, addTime: '2024-01-13' },
  ])
