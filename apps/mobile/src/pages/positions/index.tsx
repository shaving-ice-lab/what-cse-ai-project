...
export default function PositionsPage() {
  ...
  const positions: Position[] = [
    { id: 1, name: '税务局科员', department: '国家税务总局北京市税务局', location: '北京', education: '本科', major: '不限专业', recruitCount: 3, matchScore: 85 },
    { id: 2, name: '海关科员', department: '北京海关', location: '北京', education: '本科', major: '法学类', recruitCount: 2, matchScore: 78 },
    { id: 3, name: '统计局科员', department: '国家统计局上海调查总队', location: '上海', education: '本科', major: '统计学', recruitCount: 1, matchScore: 92 },
    { id: 4, name: '市场监管科员', department: '广东省市场监督管理局', location: '广州', education: '本科', major: '工商管理', recruitCount: 5, matchScore: 72 },
  ]
