    ...
    <View className='profile-page'>
      <View className='form-section'>
        ...
        <Picker
          ...
          onChange={(e) => setProfile({ ...profile, education: educationOptions[e.detail.value as number] })}
        >
          <View className='form-item'>
        ...
        <Picker
          ...
          onChange={(e) => setProfile({ ...profile, political: politicalOptions[e.detail.value as number] })}
        >
          <View className='form-item'>
        ...
        <Picker
          ...
          onChange={(e) => setProfile({ ...profile, workYears: workYearsOptions[e.detail.value as number] })}
        >
          <View className='form-item'>
