...
type Position struct {
	...
	PositionName         string          `gorm:"type:varchar(100);not null;index" json:"position_name" es:"type:text,analyzer:ik_max_word"`
	DepartmentCode       string          `gorm:"type:varchar(50);index" json:"department_code"`
	DepartmentName       string          `gorm:"type:varchar(200);index" json:"department_name" es:"type:text,analyzer:ik_max_word"`
