    ...
    <div className="space-y-12">
      ...
      <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Link to="/positions?exam_type=国考" className="flex items-center space-x-3 p-4 bg-white rounded-lg border hover:shadow-md transition-shadow">
          ...
          <Link to="/positions?exam_type=省考" className="flex items-center space-x-3 p-4 bg-white rounded-lg border hover:shadow-md transition-shadow">
          ...
          <Link to="/positions?exam_type=事业单位" className="flex items-center space-x-3 p-4 bg-white rounded-lg border hover:shadow-md transition-shadow">
          ...
          <Link to="/match" className="flex items-center space-x-3 p-4 bg-white rounded-lg border hover:shadow-md transition-shadow">
      ...
      <section>
        <div className="flex items-center justify-between mb-6">
          ...
          <Link to="/announcements" className="flex items-center text-primary hover:underline">
