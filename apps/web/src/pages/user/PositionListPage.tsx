  ...
  return (
    <div className="space-y-6">
        ...
        {showFilters && (
          <div className="border-t pt-4 space-y-4">
            ...
            <div className="flex justify-end space-x-4">
              ...
              <button className="px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/90">应用筛选</button>
            </div>
          </div>
        )}
      </div>
      ...
      <div className="flex items-center justify-between">
        <p className="text-gray-600">共找到 <span className="font-semibold text-gray-800">1,234</span> 个职位</p>
        <select className="px-4 py-2 border rounded-lg">
      ...
      <div className="space-y-4">
        {[1, 2, 3, 4, 5].map((i) => (
          <Link key={i} to={`/positions/${i}`} className="block bg-white rounded-lg p-6 hover:shadow-md transition-shadow">
