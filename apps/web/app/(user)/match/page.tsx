          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xl font-bold text-gray-800">
                {results.filter((r) => r.total_score >= 80).length}
              </p>
            </div>
          </div>
        </div>
        <div className="bg-white rounded-lg border p-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xl font-bold text-gray-800">
                {results.filter((r) => r.total_score >= 50 && r.total_score < 80).length}
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center space-x-3">
                    ...
                    <span
                      className={`px-2 py-0.5 rounded-full text-xs font-medium ${getScoreColor(result.total_score)}`}
                    >
              ...
              <div className="flex items-center justify-between mt-4 pt-4 border-t">
                <div className="flex space-x-4 text-sm">
                  <span className="text-gray-500">
                    硬性条件:{" "}
                    <span className="font-medium text-gray-700">{result.hard_score}%</span>
                  </span>
                  <span className="text-gray-500">
                    软性条件:{" "}
                    <span className="font-medium text-gray-700">{result.soft_score}%</span>
                  </span>
                </div>
                <Link
