...
function buildRequirements(position: Position) {
  ...
  if (position.major_requirement || position.is_unlimited_major) {
    const majorValue = position.is_unlimited_major
      ? "不限专业"
      : position.major_requirement || "请参考公告";
    requirements.push({
      name: "专业要求",
      value: majorValue,
  ...
  if (position.household_requirement) {
    const isNoLimit =
      position.household_requirement === "不限" || position.household_requirement.includes("无");
    requirements.push({
      name: "户籍要求",
...
export default function PositionDetailPage() {
  ...
  // 获取匹配详情（仅登录用户）
  const { data: matchData, isLoading: matchLoading } = usePositionMatchDetail(
    positionId,
    isAuthenticated
  );
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container relative mx-auto px-4 lg:px-6 pt-6 pb-10">
          ...
          <div className="bg-white/90 backdrop-blur-xl rounded-3xl border border-white shadow-2xl shadow-stone-200/50 overflow-hidden">
            ...
            <div
              className={`h-2 ${
                matchData && matchData.match_score >= 90
                  ? "bg-gradient-to-r from-emerald-400 to-emerald-500"
                  : matchData && matchData.match_score >= 70
              ...
              <div className="flex items-start justify-between gap-4 mb-8">
                <div className="flex-1">
                  <div className="flex flex-wrap items-center gap-3 mb-4">
                    {position.exam_type && (
                      <span
                        className={`px-3 py-1.5 text-sm font-semibold rounded-xl shadow-sm ${
                ...
                <div className="flex items-center gap-3 flex-shrink-0">
                  ...
                  >
                    <Heart
                      className={`w-5 h-5 transition-transform group-hover:scale-110 ${isFavorited ? "fill-current" : ""}`}
                    />
                  </button>
                  <button
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                <div className="group relative p-5 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100/50 border border-blue-100 hover:shadow-lg hover:shadow-blue-100/50 transition-all duration-300 hover:-translate-y-0.5">
                  ...
                  <p className="text-3xl font-display font-bold text-stone-900 tabular-nums">
                    ...
                    <span className="text-lg font-normal text-stone-500 ml-1">人</span>
                  </p>
                </div>
                ...
                <div
                  className={`group relative p-5 rounded-2xl border hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5 ${
                ...
                >
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    >
                      <Flame
                        className={`w-5 h-5 ${competitionRatio && competitionRatio > 100 ? "text-red-600" : "text-amber-600"}`}
                      />
                    </div>
                    <span
                      className={`text-sm font-medium ${competitionRatio && competitionRatio > 100 ? "text-red-600" : "text-amber-600"}`}
                    >
                      竞争比
                    </span>
                  </div>
      ...
      <div className="container mx-auto px-4 lg:px-6 -mt-4">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="group bg-white/80 backdrop-blur-sm rounded-2xl border border-white shadow-xl shadow-stone-200/30 hover:shadow-2xl hover:shadow-stone-200/40 transition-all duration-300 p-6 lg:p-8 overflow-hidden relative">
              ...
              <div className="relative grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="flex justify-between items-center p-4 rounded-xl bg-stone-50/80 hover:bg-stone-100/80 transition-colors">
                  ...
                  <span
                    className="font-semibold text-stone-800 text-right max-w-[180px] truncate"
                    title={position.department_name}
                  >
                ...
                {position.interview_date && (
                  <div className="flex justify-between items-center p-4 rounded-xl bg-stone-50/80 hover:bg-stone-100/80 transition-colors">
                    ...
                    <span className="font-semibold text-stone-800">
                      {formatDate(position.interview_date)}
                    </span>
                  </div>
                )}
                ...
                {requirements.map((req, index) => (
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <p
                          className={`text-sm mb-0.5 ${req.highlight === "positive" ? "text-emerald-600" : "text-stone-500"}`}
                        >
                          {req.name}
                        </p>
                  ...
                  <div className="relative space-y-6">
                    ...
                    <div
                      className={`relative p-6 rounded-2xl overflow-hidden ${
                        matchData.match_score >= 90
                          ? "bg-gradient-to-br from-emerald-50 via-emerald-100/50 to-teal-50"
                          : matchData.match_score >= 70
                            ? "bg-gradient-to-br from-amber-50 via-amber-100/50 to-orange-50"
                            : matchData.match_score >= 50
                              ? "bg-gradient-to-br from-orange-50 via-orange-100/50 to-red-50"
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <div className="flex items-baseline gap-3">
                            ...
                            <span
                              className={`px-3 py-1 text-sm font-bold rounded-xl shadow-sm ${
                                matchData.match_score >= 90
                                  ? "bg-gradient-to-r from-emerald-500 to-emerald-600 text-white"
                                  : matchData.match_score >= 70
                        ...
                        <div className="text-right">
                          ...
                          <p
                            className={`text-sm font-bold flex items-center gap-1.5 justify-end ${matchData.is_eligible ? "text-emerald-600" : "text-red-500"}`}
                          >
                          ...
                          {matchData.match_details.map((detail: MatchCondition, index: number) => (
                            ...
                            >
                              <div className="flex items-center gap-4">
                                <div
                                  className={`w-10 h-10 rounded-xl flex items-center justify-center shadow-sm transition-transform group-hover/detail:scale-110 ${
                                    detail.is_match
                                ...
                                >
                                  {detail.is_match ? (
                                    ...
                                    <X
                                      className={`w-5 h-5 ${detail.is_hard_match ? "text-red-600" : "text-amber-600"}`}
                                    />
                                  )}
                                </div>
                                <div>
                      ...
                      <div className="p-5 bg-gradient-to-r from-red-50 to-red-100/30 rounded-xl border border-red-200">
                        ...
                        <ul className="space-y-2">
                          {matchData.unmatch_reasons.map((reason: string, index: number) => (
                            <li
                              key={index}
                              className="text-sm text-red-600 flex items-start gap-2 bg-white/50 p-2 rounded-lg"
                            >
                      ...
                      <div className="p-5 bg-gradient-to-r from-blue-50 to-blue-100/30 rounded-xl border border-blue-200">
                        ...
                        <ul className="space-y-2">
                          {matchData.suggestions.map((suggestion: string, index: number) => (
                            <li
                              key={index}
                              className="text-sm text-blue-600 flex items-start gap-2 bg-white/50 p-2 rounded-lg"
                            >
                ...
                <div className="relative flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-stone-600 mb-4 leading-relaxed">
                      登录并完善个人画像后，AI
                      将为您分析该职位与您条件的详细匹配程度，包括学历、专业、年龄等多维度分析
                    </p>
                    <Link
                      href="/login"
                      className="group inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-xl hover:from-amber-600 hover:to-orange-600 transition-all shadow-lg shadow-amber-500/25 hover:shadow-xl hover:shadow-amber-500/30 text-sm font-semibold"
                ...
                <div className="relative space-y-6">
                  ...
                  {historyData.yearly_trend && historyData.yearly_trend.length > 0 && (
                    <div className="p-5 bg-gradient-to-br from-stone-50 to-stone-100/50 rounded-xl">
                      ...
                      <div className="flex items-end justify-between gap-3 h-36 px-2">
                        {historyData.yearly_trend
                          .slice(-5)
                          .map((item: YearlyTrendItem, index: number) => {
                            const maxRatio = Math.max(
                              ...historyData.yearly_trend
                                .slice(-5)
                                .map((t: YearlyTrendItem) => t.competition_ratio || 1)
                            );
                            const height =
                              maxRatio > 0 ? (item.competition_ratio / maxRatio) * 100 : 20;
                            return (
                              <div
                                key={item.year}
                              ...
                              >
                                <div className="w-full flex flex-col items-center">
                                  <span className="text-xs font-semibold text-amber-600 mb-1">
                                    {item.competition_ratio.toFixed(0)}:1
                                  </span>
                                  <div
                                ...
                                <span className="text-xs text-stone-600 font-semibold bg-white px-2 py-0.5 rounded-lg shadow-sm">
                                  {item.year}
                                </span>
                              </div>
                            );
                    ...
                    <table className="w-full text-sm">
                      <thead>
                        <tr className="bg-gradient-to-r from-stone-100 to-stone-50">
                          ...
                          <th className="text-center py-3 px-4 font-semibold text-stone-600">
                            招录
                          </th>
                          <th className="text-center py-3 px-4 font-semibold text-stone-600">
                            报名
                      ...
                      <tbody>
                        {historyData.histories
                          .slice(0, 5)
                          .map((h: PositionHistoryItem, index: number) => (
                            <tr
                              key={h.id}
                              className={`border-t border-stone-100 hover:bg-amber-50/50 transition-colors ${index % 2 === 0 ? "bg-white" : "bg-stone-50/30"}`}
                            >
                              ...
                              <td className="py-3 px-4 text-center">
                                {h.competition_ratio > 0 ? (
                                  <span
                                    className={`inline-flex px-2 py-0.5 rounded-lg font-semibold ${
                                      h.competition_ratio > 100
                                        ? "bg-red-100 text-red-600"
                                        : h.competition_ratio > 50
                  ...
                  {historyData.prediction && historyData.prediction.predicted_score > 0 && (
                    <div className="p-5 bg-gradient-to-br from-blue-50 via-indigo-50/50 to-blue-100/30 rounded-xl border border-blue-200/50 relative overflow-hidden">
                      ...
                      <div className="relative flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-4xl font-display font-bold text-blue-600 tabular-nums">
                            {historyData.prediction.predicted_score.toFixed(1)}{" "}
                            <span className="text-xl font-normal text-blue-400">分</span>
                          </p>
                        </div>
                        <div className="text-right">
                      ...
                      <p className="text-xs text-stone-500 mt-3 pt-3 border-t border-blue-200/50">
                        {historyData.prediction.basis}
                      </p>
                    </div>
                  )}
                </div>
          ...
          <div className="space-y-6">
            ...
            {registrationStatus && (
              <div
                className={`relative rounded-2xl border-2 p-6 overflow-hidden transition-all duration-300 hover:shadow-lg ${
              ...
              >
                {/* 装饰 */}
                <div
                  className={`absolute -top-8 -right-8 w-24 h-24 rounded-full blur-2xl opacity-50 ${
                    registrationStatus.status === "ended"
                      ? "bg-red-200"
                      : registrationStatus.status === "urgent"
                        ? "bg-amber-200"
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-white shadow-xl shadow-stone-200/30 p-6 overflow-hidden relative">
              ...
              <div className="relative space-y-0">
                ...
                <div className="relative flex items-start gap-4 pb-6">
                  <div
                    className={`relative z-10 w-8 h-8 rounded-full flex items-center justify-center shadow-md ${
                      registrationStatus?.status === "ended" ||
                  ...
                  <div className="flex-1 pt-1">
                    ...
                    <p className="text-sm text-stone-500 mt-0.5">
                      {formatDate(position.registration_start)}
                    </p>
                  </div>
                </div>
                ...
                <div className="relative">
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-sm font-semibold text-emerald-700 flex items-center gap-2">
                      ...
                      已选 <span className="text-lg">{compareList.length}</span>/{MAX_COMPARE_COUNT}{" "}
                      个职位
                    </span>
                    <button
                      onClick={() => {
