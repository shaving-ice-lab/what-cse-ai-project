        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center space-x-6">
              <Link
                href="/"
                className={`hover:text-primary ${pathname === "/" ? "text-primary" : "text-gray-600"}`}
              >
                首页
              </Link>
              <Link
                href="/positions"
                className={`hover:text-primary ${pathname.startsWith("/positions") ? "text-primary" : "text-gray-600"}`}
              >
                职位查询
              </Link>
              <Link
                href="/match"
                className={`hover:text-primary ${pathname.startsWith("/match") ? "text-primary" : "text-gray-600"}`}
              >
                智能匹配
              </Link>
              <Link
                href="/announcements"
                className={`hover:text-primary ${pathname.startsWith("/announcements") ? "text-primary" : "text-gray-600"}`}
              >
                公告资讯
              </Link>
            </nav>
